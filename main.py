...
def start_server():
    while True:
        process = subprocess.Popen(
            f"python -m vllm.entrypoints.openai.api_server --port 5000 --model hugging-quants/Meta-Llama-3.1-8B-Instruct-AWQ-INT4 --api-key {openai_api_key} --rope-scaling-type llama3 --rope-scaling-factor 8.0",
            shell=True
        )
